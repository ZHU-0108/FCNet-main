...
class Exp_Main(Exp_Basic):
    ...
    def train(self, setting):
        ...
        criterion1 = self._select_criterion1()
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                if self.args.use_amp:
                    with torch.cuda.amp.autocast():
                        ...
                        loss = ALPHE*criterion1(outputs, batch_y) + (1-ALPHE)*criterion(outputs, batch_y)
        ...
        # 将参数数量转换为 MB
        params_mb = params * 4 / (1024 ** 2)  # 因为一个 float32 参数占据 4 bytes
        print(f"Total parameters (MB): {params_mb:.2f}")
